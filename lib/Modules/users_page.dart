...
import 'package:chat_app/Modules/widgets/button_widget.dart';
import 'package:chat_app/Modules/widgets/from_Fild.dart';
import 'package:chat_app/Modules/widgets/list_view_tiles.dart';
import 'package:chat_app/Modules/widgets/top_par.dart';
import 'package:chat_app/Shared/network/provider/auth_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../Shared/network/provider/user_providers.dart';
...
class _UsersPageState extends State<UsersPage> {
            ...
            children: [
              ...
              CustomTextField(
                onEditingComplete: (_value) {
                  UsersPageProvider.getUsers(name: _value);
  ...
  Widget _usersList() {
    List<userModel>? _users = _pageProvider.users;
